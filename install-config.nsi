...
!define setup "./dist/SeniorProject/SeniorProject-win32-installer.exe"
 
; change this to wherever the files to be packaged reside
!define srcdir "./dist/SeniorProject/win32"
 
!define company "The Fellows Consulting Group"
 
!define prodname "SeniorProject"
!define exec "SeniorProject.exe"
